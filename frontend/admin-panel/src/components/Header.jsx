              ...
              {showProfileMenu && (
                <div style={{
                  ...
                  <div style={{ padding: '8px' }}>
                    ...
                    <Link to="/progress-icons" onClick={() => setShowProfileMenu(false)} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '10px', textDecoration: 'none', color: '#374151', fontSize: '14px', fontWeight: '500', transition: 'background 0.2s' }}>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          {[
            ...
            ...(isMainAdmin || permissions?.permissions?.canViewWallet ? [{ path: '/wallet', label: 'Wallet', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' }] : []),
            ...
            ...(isMainAdmin || permissions?.permissions?.canEditPlans ? [{ path: '/plans', label: 'Plans', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' }] : []),
