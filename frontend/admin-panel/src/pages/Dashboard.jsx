                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">
                          {dashboardData.totalCredits.toFixed(2)}
                        </div>
                      </dd>
                    </dl>
                  </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Pending Recharges</dt>
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">
                          {dashboardData.pendingRecharges}
                        </div>
                      </dd>
                    </dl>
                  </div>
                    ...
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        <div className={`h-3 w-3 rounded-full ${
                          activity.type === 'recharge' ? 'bg-yellow-500' : 
                          activity.type === 'task' ? 'bg-green-500' : 
                          activity.type === 'wallet' ? 'bg-indigo-500' : 'bg-gray-500'
                        }`}></div>
                      </div>
                      <div className="ml-4">
