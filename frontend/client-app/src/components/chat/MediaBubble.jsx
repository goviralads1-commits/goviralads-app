...
// =====================================================================
// MediaBubble (Phase 2A) — renders ONE attachment slot:
      ...
      {!failed && (
        <div style={{ marginTop: '8px' }}>
          <div style={{ height: '4px', borderRadius: '2px', backgroundColor: '#334155', overflow: 'hidden' }}>
            <div style={{ height: '100%', width: sending ? '100%' : `${pct}%`, backgroundColor: '#22c55e', borderRadius: '2px', transition: 'width 0.2s' }} />
          </div>
      ...
      {failed && (
        <div style={{ marginTop: '8px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '6px' }}>
            <button onClick={() => onRetry && onRetry(meta._tempId)} style={{ flex: 1, padding: '6px 0', borderRadius: '8px', border: 'none', backgroundColor: '#22c55e', color: '#fff', fontSize: '12px', fontWeight: '600', cursor: 'pointer' }}>Retry</button>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <span style={{ flex: 1, minWidth: 0 }}>
          <span style={{ display: 'block', height: '4px', borderRadius: '2px', backgroundColor: '#334155', overflow: 'hidden' }}>
            <span style={{ display: 'block', height: '100%', width: `${Math.round(progress * 100)}%`, backgroundColor: '#22c55e' }} />
          </span>
